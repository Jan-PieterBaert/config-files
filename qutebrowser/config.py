...
config.bind('<Ctrl+Alt+Shift+v>', 'spawn --detach /fast_files/git_repos/custum_scripts/addToMpv Video_ "{url}"')
...
config.bind('<Ctrl+Shift+v>', 'hint links spawn --detach /fast_files/git_repos/custum_scripts/addToMpv Video_ "{hint-url}"')
